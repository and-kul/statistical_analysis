...
def get_all_functions_ccn(conn, language_name: str, project_info: ProjectInfo) -> List[int]:
...
def get_all_functions_code_lines(conn, language_name: str, project_info: ProjectInfo) -> List[int]:
...
def get_all_functions_comment_lines(conn, language_name: str, project_info: ProjectInfo) -> List[int]:
...
def get_all_classes_code_lines(conn, language_name: str, project_info: ProjectInfo) -> List[int]:
...
def get_all_classes_comment_lines(conn, language_name: str, project_info: ProjectInfo) -> List[int]:
...
def get_all_classes_n_methods(conn, language_name: str, project_info: ProjectInfo) -> List[int]:
